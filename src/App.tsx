    ...
    >
      ...
      <div className="relative w-full max-w-[340px] flex flex-col items-center mb-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <a 
            href="https://analytics.vgdh.io/ais-dev-7ijkpup7wly474tz6kbnpe-495534316814.europe-west2.run.app" 
            target="_blank" 
            rel="noreferrer"
            ...
            {isMenuOpen && (
              ...
              >
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <button
                    onClick={() => {
                      window.open("https://analytics.vgdh.io/ais-dev-7ijkpup7wly474tz6kbnpe-495534316814.europe-west2.run.app", "_blank");
                    }}
